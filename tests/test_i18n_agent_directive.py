...
from mobility_advisor.agents.annual import _annual_communicator_instruction, annual_communicator_agent
from mobility_advisor.agents.optimization import communicator_agent
...
def test_annual_communicator_resolves_placeholders_and_appends_directive(monkeypatch):
    ...
    paths.DATA_DIR = _SCENARIOS / "stefan"
    try:
        async def run():
...
def test_all_six_user_facing_agents_are_localized():
    ...
    from mobility_advisor.agents.annual import annual_communicator_agent
    from mobility_advisor.agents.execution import execution_agent
    from mobility_advisor.agents.optimization import communicator_agent
    from mobility_advisor.agents.qa import qa_agent
    from mobility_advisor.agents.reject import reject_agent
